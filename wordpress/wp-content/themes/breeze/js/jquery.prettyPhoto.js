...
(function($) {
	...
	$.fn.prettyPhoto = function(settings) {
		settings = jQuery.extend({
			...
			flv_markup: '<div id="flv_video" videourl="{path}" width="{width}" height="{height}"><div id="objectflv_video"></div></div>',
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(images[setPosition])){
					...
					case 'flv':
						...
						toInject = settings.flv_markup.replace(/{width}/g,correctSizes['width']).replace(/{height}/g,correctSizes['height']).replace(/{path}/g,filename);
					break;
				...
				if(!imgPreloader){
					...
					if( _getFileType(images[setPosition]) == 'flv' ) {
						createFlvVideo($('#flv_video'));
						//alert($('#objectflv_video_api').attr('width'));
					}
		...
		*/
		...
		function createFlvVideo(element) {
			if(element.length) { // if element exists
				var player_id = element.find('div').attr('id');					
				var _url = element.attr('videourl');
				var _width = element.attr('width');
				var _height = element.attr('height');
